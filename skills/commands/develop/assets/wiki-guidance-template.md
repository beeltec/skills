...
Copy this structure for one canonical page per subject: a technology under [`technologies/`](/engineering/technologies/), a cross-cutting standard under [`standards/`](/engineering/standards/). Create and refresh pages with `$develop guidance ...`; replace every instruction with project evidence.
