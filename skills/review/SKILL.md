...
12. Use `$source` to refresh external rules from official documentation.
13. Read applicable repository standards and Git conventions.
14. Run the Standards pass against the complete change.
15. Run a fresh Spec pass against the originating work item or specification.
16. Assign P0, P1, P2, or P3 to every finding.
17. Report both results separately, including counts for every severity.
18. If any P0, P1, or P2 exists, record `changes-requested`.
19. Hand all blocking findings to `implement` and keep the fixed point.
20. After fixes, rerun both complete passes against the updated change.
21. Repeat steps 14-20 until both passes contain no P0, P1, or P2 findings.
22. Record the passing review and move the item to `in-review`.
