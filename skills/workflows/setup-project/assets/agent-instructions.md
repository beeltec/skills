...
- Use `$backlog` for backlog mutations and `$to-wiki` for accepted wiki updates. Follow the selected skill and project maintenance rules.
- Require project-owner approval to mark work `ready`, change rank, cancel work, or change accepted wiki state.
