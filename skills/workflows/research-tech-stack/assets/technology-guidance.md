...
title: '<Technology>'
description: Current project-relevant engineering guidance for <technology>.
tags: [engineering, technology]
timestamp: <ISO 8601 timestamp>
status: active
last_reviewed: <YYYY-MM-DD>
applicable_versions: '<version or range>'
freshness_tier: <fast-moving | stable | security-sensitive>
---
...
- [Source title](https://example.com) — official, version <version>, reviewed <YYYY-MM-DD>; supports <claim or section>.
