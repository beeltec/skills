...
If available, check the context length of the current session with @beeltec/context-usage-mcp after each task is done. If the sessions is greater than 150000 tokens, use /handoff.
