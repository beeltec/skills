...
- Delete replaced, erroneous, duplicate, and valueless concepts cleanly after approval instead of creating `superseded` pages — Git and archived backlog records preserve history.
