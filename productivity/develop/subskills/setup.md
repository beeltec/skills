...
Ask the user if they want to use the backlog, the wiki or both

If it exists, append the following to the AGENTS.md:
...
If the AGENTS.md does not exist yet, create it and a symlink to it called CLAUDE.md (title is "# Instruction for agents") and add the block.
